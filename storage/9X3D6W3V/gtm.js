...
"resource": {
  ...
  "macros":[{
      ...
      "function":"__jsm",
      "vtp_javascript":["template","(function(){if(\"true\"==",["escape",["macro",3],8,16],"){if(null==",["escape",["macro",4],8,16],")return\"Text View\";if(\"text\"==",["escape",["macro",4],8,16],")return\"Text View Preferred\";if(\"image\"==",["escape",["macro",4],8,16],")return\"Page View Preferred\"}return\"Page View\"})();"]
    },{
      "function":"__e"
    },{
      "function":"__v",
      ...
      "vtp_metric":["list",["map","index","1","metric",["macro",7]],["map","index","2","metric",["macro",8]]],
      "vtp_enableLinkId":false,
      "vtp_dimension":["list",["map","index","1","dimension",["macro",9]],["map","index","2","dimension",["macro",10]],["map","index","3","dimension",["macro",11]],["map","index","4","dimension",["macro",12]],["map","index","5","dimension",["macro",13]],["map","index","6","dimension",["macro",14]],["map","index","8","dimension",["macro",15]],["map","index","9","dimension",["macro",0]],["map","index","10","dimension",["macro",1]],["map","index","11","dimension",["macro",16]],["map","index","12","dimension",["macro",2]],["map","index","13","dimension",["macro",17]],["map","index","14","dimension",["macro",18]],["map","index","15","dimension",["macro",19]],["map","index","16","dimension",["macro",20]],["map","index","17","dimension",["macro",5]],["map","index","18","dimension",["macro",3]]],
      ...
      "function":"__c",
      "vtp_value":["template","cd1=",["macro",9],"\u0026cd2=",["macro",10],"\u0026cd3=",["macro",11],"\u0026cd4=",["macro",12],"\u0026cd5=",["macro",13],"\u0026cd7=yes\u0026cd8=",["macro",15],"\u0026c11=",["macro",16]]
    },{
      "function":"__u",
      "vtp_component":"URL",
      "vtp_enableMultiQueryKeys":false
  ...
  "tags":[{
      ...
      "vtp_url":["template",["escape",["macro",36],14,3],"\u0026",["escape",["macro",37],3],"\u0026t=pageview\u0026tid=",["escape",["macro",22],3],"\u0026dl=",["escape",["macro",38],3]],
      "vtp_cacheBusterQueryParam":"z",
      "vtp_randomNumber":["macro",39],
      "tag_id":11
    },{
      "function":"__img",
      "once_per_event":true,
      "vtp_useCacheBuster":true,
      "vtp_url":["template",["escape",["macro",36],14,3],"\u0026t=pageview\u0026tid=",["escape",["macro",25],3],"\u0026dl=",["escape",["macro",38],3]],
      "vtp_cacheBusterQueryParam":"z",
      "vtp_randomNumber":["macro",39],
      "tag_id":12
    },{
  ...
  "rules":[
    ...
    [["if",2,10],["add",7]],
    [["if",2,10,11],["add",8]],
    [["if",5,8],["unless",9],["add",9],["block",6]],
    [["if",8,12],["unless",9],["add",10]],
    [["if",8,13,14,15],["unless",16],["add",11]],
    [["if",8,17,18],["add",11]],
    [["if",8,19,20],["add",12]],
    [["if",1,2],["block",1,3]]]
},
...
var qd=[],rd={"\x00":"&#0;",'"':"&quot;","&":"&amp;","'":"&#39;","<":"&lt;",">":"&gt;","\t":"&#9;","\n":"&#10;","\x0B":"&#11;","\f":"&#12;","\r":"&#13;"," ":"&#32;","-":"&#45;","/":"&#47;","=":"&#61;","`":"&#96;","\u0085":"&#133;","\u00a0":"&#160;","\u2028":"&#8232;","\u2029":"&#8233;"},sd=function(a){return rd[a]},td=/[\x00\x22\x26\x27\x3c\x3e]/g;qd[3]=function(a){return String(a).replace(td,sd)};var xd=/[\x00\x08-\x0d\x22\x26\x27\/\x3c-\x3e\\\x85\u2028\u2029]/g,yd={"\x00":"\\x00","\b":"\\x08","\t":"\\t","\n":"\\n","\x0B":"\\x0b",
"\f":"\\f","\r":"\\r",'"':"\\x22","&":"\\x26","'":"\\x27","/":"\\/","<":"\\x3c","=":"\\x3d",">":"\\x3e","\\":"\\\\","\u0085":"\\x85","\u2028":"\\u2028","\u2029":"\\u2029",$:"\\x24","(":"\\x28",")":"\\x29","*":"\\x2a","+":"\\x2b",",":"\\x2c","-":"\\x2d",".":"\\x2e",":":"\\x3a","?":"\\x3f","[":"\\x5b","]":"\\x5d","^":"\\x5e","{":"\\x7b","|":"\\x7c","}":"\\x7d"},zd=function(a){return yd[a]};
...
"\uff07":"%EF%BC%87","\uff08":"%EF%BC%88","\uff09":"%EF%BC%89","\uff0a":"%EF%BC%8A","\uff0b":"%EF%BC%8B","\uff0c":"%EF%BC%8C","\uff0f":"%EF%BC%8F","\uff1a":"%EF%BC%9A","\uff1b":"%EF%BC%9B","\uff1d":"%EF%BC%9D","\uff1f":"%EF%BC%9F","\uff20":"%EF%BC%A0","\uff3b":"%EF%BC%BB","\uff3d":"%EF%BC%BD"},Jd=function(a){return Id[a]};var Kd=
/^(?:(?:https?|mailto):|[^&:\/?#]*(?:[\/?#]|$))/i;qd[14]=function(a){var b=String(a);return Kd.test(b)?b.replace(Hd,Jd):"#zSoyz"};qd[16]=function(a){return a};var Ld,Md=[],Nd=[],Od=[],Pd=[],Qd=[],Rd={},Sd,Td,Ud,Vd=function(a,b){var c={};c["function"]="__"+a;for(var d in b)b.hasOwnProperty(d)&&(c["vtp_"+d]=b[d]);return c},Wd=function(a,b){var c=a["function"];if(!c)throw Error("Error: No function name given for function call.");var d=!!Rd[c],e={},f;for(f in a)a.hasOwnProperty(f)&&0===f.indexOf("vtp_")&&(e[d?f:f.substr(4)]=a[f]);return d?Rd[c](e):Ld(c,e,b)},Yd=function(a,b,c,d){c=c||[];d=d||ya;var e={},f;for(f in a)a.hasOwnProperty(f)&&(e[f]=Xd(a[f],b,c,d));
...
var ff=function(){},ef=function(){return A.GoogleAnalyticsObject||"ga"},gf=!1;var of=function(a){var b=ge.consumeError;if(!b||!Aa(b))return;var c=[];if(a instanceof Ne){var d=a.Lc;if(d.length){d=d.slice();d.push({id:"main",line:0});for(var e=d.length-1;0<e;e--)Ba(d[e].id)&&d.splice(e++,1);for(var f=d.length-1;0<f;f--)d[f].line=d[f-1].line;d.splice(0,1)}c=d;a=a.Hg}if(a instanceof Qe){var h=a;b(nf("PERMISSION",{id:h.Mg,parameters:h.getParameters(),message:h.Dg},c));return}if(a instanceof Error){b(nf("GENERIC",{message:a.message},c));return}t(a)&&
b(nf("GENERIC",{message:a},c));};function nf(a,b,c){b.containerId=O.m;var d={type:a,value:b};c.length&&(d.trace=c);return d};
...
Z.a.d=["google"],function(){(function(a){Z.__d=a;Z.__d.g="d";Z.__d.h=!0;Z.__d.b=0})(function(a){var b=null,c=null,d=a.vtp_attributeName;if("CSS"==a.vtp_selectorType){var e=Bg(a.vtp_elementSelector);e&&0<e.length&&(b=e[0])}else b=rc(a.vtp_elementId);b&&(c=d?qc(b,d):sc(b));return La(String(b&&c))})}();Z.a.e=["google"],function(){(function(a){Z.__e=a;Z.__e.g="e";Z.__e.h=!0;Z.__e.b=0})(function(){return me})}();
...
b.vtp_trackType){var ia={hitType:"social",socialNetwork:String(b.vtp_socialNetwork),socialAction:String(b.vtp_socialAction),socialTarget:String(b.vtp_socialActionTarget)};J(E,ia,!1);v("send",ia);}else if("TRACK_TRANSACTION"==b.vtp_trackType){}else if("TRACK_TIMING"==b.vtp_trackType){
var ra={hitType:"timing",timingCategory:String(b.vtp_timingCategory||c.category),timingVar:String(b.vtp_timingVar||c.name),timingValue:Ia(b.vtp_timingValue||c.value),timingLabel:B(String,b.vtp_timingLabel||c.label)};J(E,ra,!1);v("send",ra);}else if("DECORATE_LINK"==b.vtp_trackType){}else if("DECORATE_FORM"==b.vtp_trackType){}else if("TRACK_DATA"==
