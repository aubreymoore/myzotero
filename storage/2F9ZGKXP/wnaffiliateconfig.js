/* Built by CCTRL02 on 2016-07-07 09:21:00*/
...
wnSetConfigVariable('wn.video.general.player.emaillandingpage','http://www.kuam.com/video');
wnSetConfigVariable('wn.video.general.landingpage','http://www.kuam.com/video');
wnSetConfigVariable('wn.video.general.helppage','/story/925699/player-help');
...
wnSetConfigVariable('wn.video.popupplayer.defaultskincolor','#000060');
...
wnSetConfigVariable('wn.video.landingpage.flash','http://www.kuam.com/video');
...
wnSetConfigVariable('wn.affiliatename','KUAM');
wnSetConfigVariable('wn.affiliateno',883);
wnSetConfigVariable('wn.ref.machinename','CCTRL02');
wnSetConfigVariable('wn.ref.builddatetime','2016-07-07 09:21:00');
wnSetConfigVariable('wn.rootassociations.home',164097);
wnSetConfigVariable('wn.rootassociations.weather',164098);
wnSetConfigVariable('wn.rootassociations.search',164103);
wnSetConfigVariable('wn.rootassociations.pop_video_search',164104);
wnSetConfigVariable('wn.rootassociations.pop_video_top',164105);
wnSetConfigVariable('wn.rootassociations.weatheralerts',164099);
wnSetConfigVariable('wn.rootassociations.video',173022);
wnSetConfigVariable('wn.rootassociations.slideshow',178605);
wnSetConfigVariable('wn.rootassociations.mostpopularstory',189165);
wnSetConfigVariable('wn.rootassociations.mostpopularvideo',189166);
wnSetConfigVariable('wn.globalimageprefix','http://images.worldnow.com/global');
wnSetConfigVariable('wn.staticimagefarmprefix','http://KUAM.images.worldnow.com');
wnSetConfigVariable('wn.baseurl','www.kuam.com');
wnSetConfigVariable('wn.showads',1);
wnSetConfigVariable('wn.brandinggraphic',1);
wnSetConfigVariable('wn.pagetitletag','KUAM.com-KUAM News: On Air. Online. On Demand.');
wnSetConfigVariable('wn.searchlocation',1);
wnSetConfigVariable('wn.registration.membercenterlocation',1);
wnSetConfigVariable('wn.registration.linkno',557066);
...
wnSetConfigVariable('wn.socialtools.mobdub.partnerid',104);
wnSetConfigVariable('wn.socialtools.mobdub.partnerdomain','http://dub.kuam.com');
...
wnSetConfigVariable('wn.socialtools.comments.termsofuse','We welcome your participation in our community. Please keep your comments civil and on point.  Comments that include profanity, or personal attacks, or antisocial behavior such as "spamming" or "trolling," or other inappropriate comments or material will be removed from this site. We will take steps to block users who violate any of our terms of use. You are fully responsible for the content that you post. You must be at least 13 years of age to post comments.  By submitting a comment, you agree to these');
...
wnSetConfigVariable('wn.socialtools.ratings.story.display',true);
wnSetConfigVariable('wn.socialtools.ratings.story.requireregistration',false);
wnSetConfigVariable('wn.socialtools.addthistools.pubid','ra-50b8067f02986214');
...
wnSetConfigVariable('wn.contentaddons.betalist','ghostad');
...
wnSetConfigVariable('wn.contentaddons.customized.feature.metatags.meta.content',39567613741);
wnSetConfigVariable('wn.contentaddons.customized.feature.move.item','#DisplaySizeId68');
wnSetConfigVariable('wn.contentaddons.customized.feature.move.to','#WNCol4');
wnSetConfigVariable('wn.contentaddons.customized.feature.move.style','prepend');
wnSetConfigVariable('wn.contentaddons.customized.feature.stylesheets.stylesheet.href','/global/css/customizations/normalize.css');
wnSetConfigVariable('wn.contentaddons.customized.feature.stylesheets.stylesheet.href','/global/css/customizations/base.css');
wnSetConfigVariable('wn.contentaddons.customized.feature.stylesheets.stylesheet.href','/global/css/customizations/layouts.css');
wnSetConfigVariable('wn.contentaddons.customized.feature.stylesheets.stylesheet.href','http://ftpcontent.worldnow.com/professionalservices/clients/kuam/custom.css');
wnSetConfigVariable('wn.contentaddons.customized.feature.stylesheets.stylesheet.href','http://ftpcontent.worldnow.com/professionalservices/clients/kuam/custom-mobile.css');
wnSetConfigVariable('wn.contentaddons.customized.feature.stylesheets.stylesheet.href','http://ftpcontent.worldnow.com/kuam/custom/kuam.css');
wnSetConfigVariable('wn.contentaddons.customized.feature.scripts.script.src','http://ftpcontent.worldnow.com/professionalservices/clients/kuam/custom.js');
wnSetConfigVariable('wn.contentaddons.customized.feature.scripts.script.src','http://ftpcontent.worldnow.com/professionalservices/clients/kuam/custom-mobile.js');
...
wnSetConfigVariable('wn.membercenterdomain','https://kuam.membercenter.worldnow.com');
