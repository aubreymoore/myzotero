...
$('.edit-project-title-block .icon-block').click(function () {
    ...
    _this.next('.save-project-title').find('input').val(titleContent);
});
...
$('.save-project-title button').click(function () {
    ...
    var inputContent = _this.find('input').val();
...
$('.edit-project-title a.editsumm').click(function () {
    ...
    _this.next('.save-project-title').find('textarea').val(titleContent);
});
...
$('.save-project-title button').click(function () {
    ...
    _this.hide();
    _this.prev('.edit-project-title').show();
    var inputContent = _this.find('textarea').val();
...
function checkboxSeclection1() {
    ...
    var countTotal = 0;
    $('#projectSearches #sort-wrapper tr, #projectSearchesMobile #MyProjectSearchesRepeater .custom-control').each(function () {
...
$('.icon-link.show-Refinement-mobile').click(function () {
    $(this).prev('.refinement-detail').slideToggle('slow');
...
$(document).ready(function () {
    ...
    $(".htmlrenderabletext").each(function () {
        var element = $(this).children()[0].outerHTML;
        ...
        .text();
        $(this).html(element + decodeURIComponent(encodedtext));//decode the encoded text
    });
})