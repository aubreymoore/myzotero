/* Un-minified with http://www.danstools.com/javascript-beautify/ to make debugging easier */
/*
 ** Annotator v1.2.10
...
! function () {
    ...
    if (((_ref1 = g.document) != null ? _ref1.evaluate : void 0) == null) {
        $.getScript("https://www.cabdirect.org/scripts/cabicd4/xpath.min.js");
    }
    if (g.getSelection == null) {
        $.getScript("https://www.cabdirect.org/scripts/cabicd4/ierange.min.js");
    }
    if (g.JSON == null) {
        $.getScript("https://www.cabdirect.org/scripts/cabicd4/json2.min.js");
    }
    if (g.Node == null) {
        g.Node = {
            ELEMENT_NODE: 1,
