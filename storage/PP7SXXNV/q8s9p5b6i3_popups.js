(function(window) {
    ...
    var account = window[window.MailerLiteObject]('accounts')('655132', 'q8s9p5b6i3');
...
(function (window) {
    ...
    cookieName = 'mailerlite:webform:submited:1028010';
    var lastSubmited = getCookie(cookieName);

    if (!lastSubmited) {
    
var cookieName = 'mailerlite:webform:shown:1028010';
...
if (allow_by_device) {
          ...
          var webform = account('webforms', 1028010, 'f7z2p0', 'load');
