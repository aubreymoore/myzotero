...
$(".image-set-row__thumb-images").on("click","img",function(e){var parentRow=$(this).closest(".image-set-row");parentRow.find(".image-set-row__main-image img").attr("src",$(this).attr("src"));});});function handleJournalActiveBasedLinks(journalName,link,event,isPublic,isAcceptingSubmissions,isDiscontinued){var msg="";if(isDiscontinued){msg="<em>"+journalName+"</em> is discontinued: "+link.data("disabledmessage");}
