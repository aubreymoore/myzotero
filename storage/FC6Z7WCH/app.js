(function (_w, _s) {
    ...
    app = {
        ...
        register: function (account, zone, size, div, opt) {
            ...
            if (account == 158636) { // || account == 142519
            ...
            // sf
            if (account == 167676 || account == 164128) {
                opt.domain = 'adbutler-fermion.com';
                request.opt.adserveVersion = 'adserve-p';
            }
            
            var betaTesters = [ 172084, 169749,
                167981, 172058, 167641, 161097, 168596, 170779,
                172162, 165080, 161650, 168934,
                    170184, 165194, 171310, 170373, 171825, 167691, 167981, 168518, 168679, 170964,
                    172310, 172185, 169430, 158913, 158914, 158915, 172058, 171804, 169558, 169815,
                    168351, 172449, 171098, 165450, 169286, 169395, 167642, 161095, 161097, 161098,
                    168596, 169049, 169164, 167548, 168170, 167360, 167068, 170779, 169442, 166046,
                    167687, 161974, 171529, 171694, 172365
            ];
            if(betaTesters.indexOf(account) >= 0){
                opt.domain = 'adbutler-fermion.com';
                request.opt.adserveVersion = 'adserve-p';
            }
