...
/* contents of /scripts/jquery-3.1.1.min.js */
...
/* contents of /scripts/sidr/jquery.sidr.js */
...
/* contents of /scripts/parallax/parallax.js */
...
/* contents of /scripts/fancybox/source/jquery.fancybox.js */
...
$(document).ready(function() {
    ...
    $('#offcanvas-menu').sidr({
        ...
        side: 'right',
        source: '#sidr',
        onOpen: function () {$("#burger").attr("src","/styles/images/burger-x-2.png")},
        onClose: function () {$("#burger").attr("src","/styles/images/burger-2.png")}
    });

    $('#sidr-body-overlay').click(function () {
        $.sidr('close', 'sidr');
    });

    $(".fancybox").fancybox();

    $("#privacy_checkbox").change(updateSubmitButton);
    ...
    $(window).scroll(function() {
        ...
        if($("#story-list").length > 0) {
            var listTop = $("#story-list").offset().top;
            if(listTop) {
                var diff = listTop - scrollPosition;
                if(diff < 110) {
                    $("div.skyscraper-banner .banner").addClass("fixed");
                } else {
                    $("div.skyscraper-banner .banner").removeClass("fixed");
                }
            }
        }

        if(scrollPosition > 35) {
            $('header.pagehead').addClass("collapsed");
        } else {
            $('header.pagehead').removeClass("collapsed");
        }
    });

    $('span#toggle-input').on('click', function(){
        $('input#searchfield').toggleClass('hidden');
...
(min-resolution: 1.5dppx)";
    ...
    if (window.devicePixelRatio > 1 || (window.matchMedia && window.matchMedia(query).matches)) {
        ...
        $(".retina").each(function() {
            ...
            var image = bg.substring(5, bg.length - 2);
            ...
            $(this).css({'background-image':'url(' + updateImage + ')'});
        });
    }
}
...
function updateSubmitButton() {
    if($("#privacy_checkbox").is(':checked')) {
        $("#privacy_checkbox").parent().removeClass("error");
    } else {
        $("#privacy_checkbox").parent().addClass("error");
    }
}
...
$(document).ready(function() {
    $("a.cookies-denied").click(function() {
        acceptCookies(false);
    });
    $("a.cookies-accepted").click(function() {
        acceptCookies(true);
    });
});
