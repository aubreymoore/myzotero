var PF_VERSION = "2018-05-24-183747360";
...
var pfMod = window.pfMod || function(l, e) {
  ...
  var a = {
    ...
    isWix: function() {
      return -1 !== f.ogImageUrl().indexOf("wixstatic.com");
    },
    isOverBlog: function() {
      return -1 !== f.ogImageUrl().indexOf("over-blog-kiwi.com");
    },
  ...
  -1 !== "|full-size|remove-images|large|medium|small|".indexOf("|" + l.pfImagesSize + "|") ? p.imagesSize = l.pfImagesSize : p.imagesSize = 1 == l.pfHideImages ? "remove-images" : "full-size";
  var m = {
    version: PF_VERSION,
    initialized: !1,
    finished: !1,
    ...
    sanitizeLocation: function() {
      url = document.location.href.split("?")[0], url = f.removeEmailsFromUrl(url), url !== document.location.href && (history && "function" == typeof history.pushState ? history.pushState({
        pf: "sanitized"
    ...
    setVariables: function() {
      ...
      this.config.urls.page = t, this.userSettings = p, this.config.pfstyle = l.pfstyle, 
    ...
    isRedirectNecessary: function() {
      var e = l.pfstyle && "wp" != l.pfstyle, t = f.isDynamicPage(), n = f.isLocalHost(), i = f.isWix() || f.isOverBlog();
      if (m.stats.page = {
        bm: e,
        dynamic: t,
        local: n,
