...
if (person) {
pi = person.Title + " " + person.Initials + " " + person.FamilyName;
...
var grantTipTitle = this.constructTipTitle(funderName, grantID);
 ...
 var linkToSearch = '/search?query=GRANT_AGENCY:%22'+ funderName + '%22 GRANT_ID:%22'+ grantID+'%22';
...
var grantDetailsUrl = '/grantfinder/grantdetails?query=gid:"' + grantID + '"';
if (piForSearch) {
...
var clazz = Object.getPrototypeOf(this);
var url = '/grist/rest/get/query=gid:"' + grantID + '"&resultType=core&format=json';
...
var clazz = Object.getPrototypeOf(this); 
var url = 'http://www.ebi.ac.uk/europepmc/webservices/rest/search?query=GRANT_AGENCY:"' + funderName + '" GRANT_ID:"' + grantID + '"&format=json';
var jqxhr = $.get(url, function(data) {
