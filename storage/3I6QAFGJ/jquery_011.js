...
$.TokenList = function (input, url_or_data, settings) {
    ...
    var timeout;
    var input_val;
	var placeholderText = (settings.placeHolder ? settings.placeHolder : '');
	
    // Create a new text input an attach keyup events
    var input_box = $("<input type=\"text\"  autocomplete=\"off\" placeholder=\"" + placeholderText + "\">")
        .css({
            outline: "none"
        })
    ...
    function resize_input() {
        ...
        input_box.width(input_resizer.width() + 130);
    }
