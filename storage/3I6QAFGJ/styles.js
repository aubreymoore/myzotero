...
CKEDITOR.stylesSet.add( 'default', [
	...
	*/
	{	
		name: 'Custom Image',
		element: 'div',
		attributes: { class: 'imageWrapper' }
	},
	{ name: 'Italic Title',		element: 'h2', styles: { 'font-style': 'italic' } },
	{ name: 'Subtitle',			element: 'h3', styles: { 'color': '#aaa', 'font-style': 'italic' } },
	//{ name: 'Normal P',		element: 'p', styles: { 'margin-left': '0px', 'text-indent': '0px' } },
	
	{ name: 'Indent P',		element: 'p', attributes: { 'class': 'Indent_P' } },
	{ name: 'Normal P',		element: 'p', attributes: { 'class': 'Normal_P' } },
