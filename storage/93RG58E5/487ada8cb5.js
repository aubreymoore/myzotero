...
"none";else{var adWrapper=c["adWrapper"];var target=iframeID;do target=target.parentElement;while(target.classList.contains(adWrapper)===false);target.style.display="none"}}closeAdSpot(edata["closeAdSpot"])}if(edata["surveymonkey"]){function surveymonkey(c){(function(t,e,c,o){var s,n,r;t.SMCX=t.SMCX||[],e.getElementById(o)||(s=e.getElementsByTagName(c),n=s[s.length-1],r=e.createElement(c),r.type="text/javascript",r.async=!0,r.id=o,r.src=["https:"===location.protocol?"https://":"http://","widget.surveymonkey.com/collect/website/js/DEFf7YOHV0FmgI8ttMr4yidF6jpL_2Bqro_2F77MNRqVve249WGRP4LsLfcfTYN6uX5c.js"].join(""),
n.parentNode.insertBefore(r,n))})(window,document,"script","smcx-sdk")}surveymonkey(edata["surveymonkey"])}if(edata["ngmlauncher"]){function ngmLauncher(c){(function(i,s,o,g,r,a,m){i["GoogleAnalyticsObject"]=r;i[r]=i[r]||function(){(i[r].q=i[r].q||[]).push(arguments)},i[r].l=1*new Date;a=s.createElement(o),m=s.getElementsByTagName(o)[0];a.async=1;a.src=g;m.parentNode.insertBefore(a,m)})(window,document,"script","https://www.google-analytics.com/analytics.js","ga");ga("create","UA-8669708-15","auto",
{"siteSpeedSampleRate":10});var lmedia=c["lmedia"];lmedia=decodeURIComponent(lmedia);var lcurl=c["lcurl"];lcurl=decodeURIComponent(lcurl);var lprecurl=c["lprecurl"];lprecurl=decodeURIComponent(lprecurl);var limptrk=c["limptrk"];limptrk=decodeURIComponent(limptrk);var sasimp=lcurl.replace("adclick","count/act\x3d1");sasimp='\x3cimg src\x3d"'+sasimp+'" style\x3d"display:none;width:1px;height:1px;"\x3e';if(limptrk)limptrk='\x3cimg src\x3d"'+limptrk+'" style\x3d"display:none;width:1px;height:1px;"\x3e';
else limptrk="";var scr=c["scr"];scr=decodeURIComponent(scr);var cba=c["cba"];var j=false;function clickOTP(e){var stopT=(new Date).getTime();var timeSinceLaucher=stopT-startT;if(timeSinceLaucher>=1E3&&j===false){ga("send","timing","user_interactions","time-to-click",timeSinceLaucher);j=true}if(timeSinceLaucher<1E3)e.preventDefault();else{closeOTP();return true}}var dcid=c["ldcid"];var dcOrd=Math.round(Math.random()*1E8);var dcMarkup='\x3cdiv id\x3d"ngmlauncher" style\x3d"display:none;"\x3e\x3ca id\x3d"launcherclose"\x3e\x3cimg src\x3d"https://nzme-ads-production.s3.amazonaws.com/img/rsz_close.png" width\x3d"55" style\x3d"z-index: 3; position:absolute; right:10%;"\x3e\x3cp style\x3d"color: white;position: absolute;right: 20%; top:90%; z-index: 2;font-size: 12px;"\x3e[X]Close\x3c/p\x3e\x3c/a\x3e\x3ca id\x3d"launchercreative"  href\x3d"'+
...
(new Date).getTime();var otp=document.getElementById("ngmlauncher");otp.parentElement.removeChild(otp);document.body.style.overflow="auto";var timeSinceLaucher=stopT-startT;if(j===false){ga("send","timing","user_interactions","time-to-close",timeSinceLaucher);j=true}}}ngmLauncher(edata["ngmlauncher"])}if(edata["viewroll"]){function renderVideo(a,adspot){$(document).ready(function(){var vsiteVer=a["vsiteVer"];var vmedia=a["vmedia"];vmedia=decodeURIComponent(vmedia);var vcomp=a["vcomp"];vcomp=decodeURIComponent(vcomp);
var vcurl=a["vcurl"];vcurl=decodeURIComponent(vcurl);var vsimp=a["vsimp"];vsimp=decodeURIComponent(vsimp);var veimp=a["veimp"];veimp=decodeURIComponent(veimp);var vpos=a["vpos"];var vwide=a["vwide"];var vfcid=a["vfcid"];var sasimp=vcurl.replace("adclick","count/act\x3d1");var sasact=vcurl.replace("adclick","count/act\x3d3");var vwidth,vheight,vban,voffsetD=210,vCRlab="",vCRcount="",vname,vClass,vskip=-1,video,firstplay=true;var vscripts,vindex=0;vscripts=["https://vjs.zencdn.net/4.7.1/video.js","https://cdn.jsdelivr.net/viewability/latest/viewability.min.js",
"https://nzme-ads-production.s3.amazonaws.com/js/iphone-inline-video.min.js"];var wideUICss="";function load_script(){if(vindex<vscripts.length)$.getScript(vscripts[vindex],function(){vindex++;load_script()});else startVR()}load_script();function startVR(){$("head").append('\x3clink rel\x3d"stylesheet" href\x3d"https://vjs.zencdn.net/4.7/video-js.css" type\x3d"text/css" /\x3e');$("head").append('\x3clink rel\x3d"stylesheet" href\x3d"https://nzme-ads-production.s3.amazonaws.com/css/viewroll.css" type\x3d"text/css" /\x3e');
if(vpos==1){vClass="vr_block";vwidth=300;if(vcomp){vheight=200;vClass="vr_block vr_comp"}else vheight=250}if(vpos==2)if(vwide){vwidth=540;vheight=305;vCRlab='\x3cdiv id\x3d"vlab"\x3e\x26dtrif; Advertising \x26dtrif;\x3c/div\x3e';vCRcount='\x3cdiv id\x3d"vcount"\x3e\x3cp\x3eClose ad\x26nbsp;\x26nbsp;\x26nbsp;\x26#10006;\x3c/p\x3e\x3c/div\x3e';voffsetD=260;vClass="vr_wide";vskip=5;wideUICss=" top:auto!important;"}else{vClass="vr_block advert";vwidth=300;if(vcomp){vheight=200;vClass="vr_block advert vr_comp"}else vheight=
250}if(vpos==3){vClass="vr_block";vwidth=300;if(vcomp){vheight=200;vClass="vr_block vr_comp"}else vheight=250}var vmutebutton='\x3cimg id\x3d"vunmutebtn" src\x3d"https://nzme-ads-production.s3.amazonaws.com/img/viewroll-mute.png" style\x3d" display:none; position: absolute; top:8px; z-index: 10; right: 5px; width: 30px; cursor: pointer;'+wideUICss+'"\x3e';var vunmutebutton='\x3cimg id\x3d"vmutebtn" src\x3d"https://nzme-ads-production.s3.amazonaws.com/img/viewroll-unmute.png" style\x3d" display: inline-block; position: absolute; top:8px; z-index: 10; right: 5px; width: 30px; cursor: pointer;'+
...
"{'clickUrl':'%%CLICKURL%%','widthBreakpoint':'','expandDirection':'undefined','preferredClickThroughWindow':'new','placementId':'"+adid+"','clickEvent':'advertiser','externalAdServer':'Custom','tagVersion':'4'};\n"+"var req \x3d document.createElement('script');\n"+"req.id \x3d params.scriptId \x3d 'celtra-script-' + (window.celtraScriptIndex \x3d (window.celtraScriptIndex||0)+1);\n"+"params.clientTimestamp \x3d new Date/1000;\n"+"params.clientTimeZoneOffsetInMinutes \x3d new Date().getTimezoneOffset();\n"+
...
if(bodyAd){bodyAd.style.width="100%";bodyAd.style.maxWidth="none";bodyAd.insertAdjacentHTML("afterbegin",celtra)}}if(edata["NZHSlider"]){function SliderLauncherD(c){var lmedia=c["lmedia"];lmedia=decodeURIComponent(lmedia);var lcurl=c["lcurl"];lcurl=decodeURIComponent(lcurl);var limptrk=c["limptrk"];limptrk=decodeURIComponent(limptrk);if(limptrk)limptrk='\x3cimg src\x3d"'+limptrk+'" style\x3d"display:none;width:1px;height:1px;"\x3e';else limptrk="";var sasimp=lcurl.replace("adclick","count/act\x3d1");
sasimp='\x3cimg src\x3d"'+sasimp+'" style\x3d"display:none;width:1px;height:1px;"\x3e';var zoomtrack=lcurl.replace("adclick","count/act\x3d3");zoomtrack='\x3cimg src\x3d"'+zoomtrack+'" style\x3d"display:none;width:1px;height:1px;"\x3e';var zoomTracked=false;var lotameZoom=c["lotamezoom"];lotameZoom=decodeURIComponent(lotameZoom);lotameZoom='\x3cimg src\x3d"'+lotameZoom+'" style\x3d"display:none;width:1px;height:1px;"\x3e';var lotameZoomTracked=false;var markup='\x3cdiv id\x3d"sldr_div"\x3e'+'\x3cdiv id\x3d"sldr_clip"\x3e'+
'\x3cdiv id\x3d"sldr_crtv"\x3e'+'\x3cimg id\x3d"sldr_img" src\x3d"'+lmedia+'"\x3e'+"\x3c/div\x3e"+"\x3c/div\x3e"+'\x3cspan id\x3d"sldr_lbltop"\x3e\x26#9660; Advertisement \x26#9660;\x3c/span\x3e'+'\x3cspan id\x3d"sldr_lblbot" style\x3d"bottom: 0px;"\x3eClick Ad to Expand\x3c/span\x3e'+limptrk+sasimp+"\x3c/div\x3e";var divCR=iframeID;do divCR=divCR.parentElement;while(divCR.classList.contains("ad-container")===false);if(divCR){$(divCR).replaceWith(markup);divCR.style.margin=0;divCR.style.width="auto";
divCR.style.padding=0;divCR.style["float"]="none";divCR.style.removeProperty("height")}var zoom=""+'\x3cdiv id\x3d"sldr_zm"\x3e'+'\x3cdiv id\x3d"sldr_zm_container"\x3e'+'\x3cdiv id\x3d"sldr_zm_wrap"\x3e'+'\x3ca id\x3d"sldr_close" href\x3d"##"\x3e'+'\x3cimg src\x3d"https://nzme-ads-production.s3.amazonaws.com/img/rsz_close.png" width\x3d"50"\x3e'+"\x3c/a\x3e"+'\x3ca href\x3d"'+lcurl+'" target\x3d"_blank"\x3e'+'\x3cimg id\x3d"sldr_zm_img" src\x3d"'+lmedia+'"\x3e'+"\x3c/a\x3e"+"\x3c/div\x3e"+"\x3c/div\x3e"+
"\x3c/div\x3e";var zoomIns=document.getElementsByTagName("body")[0];if(zoomIns)zoomIns.insertAdjacentHTML("afterbegin",zoom);var zoomState=false;function togZoom(){var zm=document.getElementById("sldr_zm");var zm_container=document.getElementById("sldr_zm_container");var zm_wrap=document.getElementById("sldr_zm_wrap");var zm_img=document.getElementById("sldr_zm_img");var zm_close=document.getElementById("sldr_close");var crtv=document.getElementById("sldr_crtv");if(!zoomState){zm.setAttribute("style",
"height:100vh;opacity:1;");zm_container.setAttribute("style","top: auto; margin: 0 auto; width: 100%; left: auto; text-align: center;");zm_wrap.setAttribute("style","position: relative;display: inline-block;");zm_img.setAttribute("style","height:86vh;");zm_close.setAttribute("style","display: block;position: absolute; right: -2px; top:19px");crtv.style.display="none";zoomState=!zoomState;if(!zoomTracked){document.body.insertAdjacentHTML("afterbegin",zoomtrack);document.body.insertAdjacentHTML("afterbegin",
lotameZoom);zoomTracked=true}}else if(zoomState){zm.style.opacity=0;zm.style.height=0;zm_img.style.height=0;zm_close.style.display="none";crtv.style.display="block";zoomState=!zoomState}}document.getElementById("sldr_clip").addEventListener("click",togZoom);document.getElementById("sldr_zm").addEventListener("click",togZoom)}SliderLauncherD(edata["NZHSlider"])}if(edata["pushdown"])(function(){function Pushdown(){var t=this;t.curl=decodeURIComponent(edata["pushdown"]["curl"]);t.imptrk=decodeURIComponent(edata["pushdown"]["imptrk"]);
t.cta=decodeURIComponent(edata["pushdown"]["cta"]);t.logo=decodeURIComponent(edata["pushdown"]["logo"]);t.videoHq=decodeURIComponent(edata["pushdown"]["videoHq"]);t.videoLq=decodeURIComponent(edata["pushdown"]["videoLq"]);t.backupHq=decodeURIComponent(edata["pushdown"]["backupHq"]);t.backupLq=decodeURIComponent(edata["pushdown"]["backupLq"]);t.fcid=edata["fcid"];t.pdEnv=edata["pushdown"]["pdEnv"];if(t.imptrk)t.imptrk='\x3cimg src\x3d"'+t.imptrk+'" style\x3d"display:none;width:1px;height:1px;"\x3e';
t.sasimp=t.curl.replace("adclick","count/act\x3d1");t.sasimp='\x3cimg src\x3d"'+t.sasimp+'" style\x3d"display:none;width:1px;height:1px;"\x3e';t.sasact=t.curl.replace("adclick","count/act\x3d3");t.sasact='\x3cimg src\x3d"'+t.sasact+'" style\x3d"display:none;width:1px;height:1px;"\x3e';t.enviros={"desktop":{"vparams":"playsinline preload loop muted","vasset":t.videoHq,"iasset":t.backupHq},"mobile-data":{"vparams":"playsinline preload loop","vasset":t.videoLq,"iasset":t.backupLq},"mobile-wifi":{"vparams":"playsinline preload loop muted",
"vasset":t.videoLq,"iasset":t.backupLq},"wifi-ios-10":{"vparams":"playsinline preload loop muted","vasset":t.videoLq,"iasset":t.backupLq}};t.window_sY;t.window_w;t.nzh_hamnav;t.main;t.pd_div;t.pd_clip;t.pd_crtv;t.pd_closebtn;t.pd_down;t.pd_logo_link;t.pd_overlay_link;t.main_w;t.main_h;t.main_x;t.pd_view;t.pd_cont=document.createElement("div");t.pd_cont.setAttribute("id","pd_div");t.pd_appeared=false;t._loadScript=function(url,callback){var script=document.createElement("script");script.type="text/javascript";
if(script.readyState)script.onreadystatechange=function(){if(script.readyState=="loaded"||script.readyState=="complete"){script.onreadystatechange=null;if(callback)callback()}};else script.onload=function(){if(callback)callback()};script.src=url;document.getElementsByTagName("head")[0].appendChild(script)};t._loadCss=function(url,callback){var pdcss=document.createElement("link");pdcss.type="text/css";pdcss.rel="stylesheet";pdcss.href=url;document.head.appendChild(pdcss);if(callback)callback()};t._getMarkupTemplate=
function(){var parser=new DOMParser;var m="";m+='  \x3cdiv id\x3d"pd_controls"\x3e';m+='    \x3cdiv id\x3d"pd_closebtn"\x3e\x3c/div\x3e';m+="  \x3c/div\x3e";m+='  \x3cdiv id\x3d"pd_logo"\x3e';m+='    \x3ca target\x3d"_blank" href\x3d"'+t.curl+'"\x3e\x3cimg src\x3d"'+t.logo+'"\x3e\x3c/a\x3e';m+="  \x3c/div\x3e";m+='  \x3cdiv id\x3d"pd_overlay"\x3e';m+='    \x3ca target\x3d"_blank" href\x3d"'+t.curl+'"\x3e\x3cimg src\x3d"'+t.cta+'"\x3e\x3c/a\x3e';m+="  \x3c/div\x3e";m+='  \x3cdiv id\x3d"pd_up"\x3e';
m+='    \x3cspan id\x3d"pd_uptext"\x3eADVERTISEMENT\x3c/span\x3e';m+="  \x3c/div\x3e";m+='  \x3cdiv id\x3d"pd_down"\x3e';m+='    \x3cdiv id\x3d"pd_downarrow"\x3e';m+='      \x3ca href\x3d"#"\x3e';m+='        \x3cspan id\x3d"pd_bottom"\x3e\x3c/span\x3e';m+="      \x3c/a\x3e";m+="    \x3c/div\x3e";m+="    \x3cbr\x3e";m+='    \x3cspan id\x3d"pd_downtext"\x3eCONTINUE TO NZ HERALD\x3c/span\x3e';m+="  \x3c/div\x3e";m+='  \x3cdiv id\x3d"pd_shadow"\x3e\x3c/div\x3e';m+='  \x3cdiv id\x3d"pd_clip"\x3e';m+='    \x3cdiv id\x3d"pd_crtv" style\x3d"display: block;"\x3e';
m+="    \x3c/div\x3e";m+="  \x3c/div\x3e";var markup=parser.parseFromString(m,"text/html");return markup};t._generateFinalMarkup=function(markup){t.pd_cont.innerHTML=markup};t._addEventListeners=function(){window.addEventListener("resize",t._adjustContainer);t.pd_closebtn.addEventListener("click",t._removePushdown);t.pd_down.addEventListener("click",t._removePushdown);t.pd_logo_link.addEventListener("click",t._clickTrack);t.pd_overlay_link.addEventListener("click",t._clickTrack)};t._removeEventListeners=
function(){t.pd_closebtn.removeEventListener("click",t._removePushdown);t.pd_down.removeEventListener("click",t._removePushdown);window.removeEventListener("resize",t._adjustContainer);t.pd_logo_link.removeEventListener("click",t._clickTrack);t.pd_overlay_link.removeEventListener("click",t._clickTrack)};t._addToDOM=function(){t.main=document.getElementById("main");t.main.insertBefore(t.pd_cont,t.main.firstChild);t.nzh_hamnav=document.querySelector(".compressed .site-logo-wrapper");t.pd_div=document.getElementById("pd_div");
t.pd_clip=document.getElementById("pd_clip");t.pd_crtv=document.getElementById("pd_crtv");t.pd_closebtn=document.getElementById("pd_closebtn");t.pd_down=document.getElementById("pd_down");t.pd_logo_link=document.querySelector("#pd_logo a");t.pd_overlay_link=document.querySelector("#pd_overlay a");t.main_w=t.main.offsetWidth;t.main_h=t.main_w/1.78;t.main_x=t.main.getBoundingClientRect();t.main_x=t.main_x.left;t._addEventListeners()};t._showPushdown=function(){t.pd_div.style.display="block";t._adjustContainer();
t.pd_div.style.opacity="1";t.pd_cont.insertAdjacentHTML("afterend",'\x3cimg style\x3d"display:none;" src\x3d"https://data.apn.co.nz/apnnz/count/actname\x3dAdCreativeView/fcid\x3d'+t.fcid+'"\x3e');t.pd_cont.insertAdjacentHTML("afterend",t.sasimp)};t._clickTrack=function(){console.log("PD click track!");t.pd_cont.insertAdjacentHTML("afterend",'\x3cimg style\x3d"display:none;" src\x3d"https://data.apn.co.nz/apnnz/count/actname\x3dPushdownClick/fcid\x3d'+t.fcid+'"\x3e')};t._checkScroll=function(){t.pd_view=
viewability.vertical(t.pd_div);t.pd_view=t.pd_view["value"];t.pd_div.style.opacity=t.pd_view;t.window_sY=window.pageYOffset};t._adjustContainer=function(){t.main_w=t.main.offsetWidth;t.main_h=t.main_w/1.78;t.main_x=t.main.getBoundingClientRect();t.main_x=t.main_x.left;t.pd_div.style.height=t.main_h+"px";t.pd_clip.style.height=t.main_h+"px";t.pd_crtv.style.height=t.main_h+"px";t.pd_clip.style.width=t.main_w+"px";t.pd_crtv.style.width=t.main_w+"px";t.pd_crtv.style.left=t.main_x+"px";t.window_w=window.innerWidth;
if(t.window_w<567&&t.nzh_hamnav)t.nzh_hamnav.style.marginTop=t.main_h+10+"px";else if(t.nzh_hamnav)t.nzh_hamnav.style.removeProperty("margin-top")};t._removePushdown=function(){t.pd_div.style.height="0px";t.pd_clip.style.height="0px";if(t.nzh_hamnav)t.nzh_hamnav.style.removeProperty("margin-top");t.pd_cont.insertAdjacentHTML("afterend",'\x3cimg style\x3d"display:none;" src\x3d"https://data.apn.co.nz/apnnz/count/actname\x3dAdClosed/fcid\x3d'+t.fcid+'"\x3e');t._removeEventListeners()};t._loadCss("https://nzme-ads-production.s3.amazonaws.com/css/pushdown.css")}
function PushdownVideo(){Pushdown.call(this);var t=this;var pd_video;var pd_videoClick;var pd_rdy;var pd_video_rdy;var pd_hasplayed;var pd_volumebtn;var pd_mutebtn;var pd_unmutebtn;var pd_firstRun=true;var pd_overlay;var pd_logo;var pd_closeNavBtn;var firstplay=true;var firstend=true;var soundUnmuted=false;var vctime,vdur,vprc;var vtime25=false;var vtime50=false;var vtime75=false;var vtime100=false;var vtime5sec=false;t.generateVideoMarkup=function(){var markupTemplate=t._getMarkupTemplate();var controlsMarkup=
"";controlsMarkup+='\x3cdiv id\x3d"pd_volumebtn"\x3e';controlsMarkup+=' \x3cimg id\x3d"pd_mutebtn" src\x3d"https://nzme-ads-production.s3.amazonaws.com/img/mute.png"\x3e';controlsMarkup+=' \x3cimg id\x3d"pd_unmutebtn" src\x3d"https://nzme-ads-production.s3.amazonaws.com/img/vol.png"\x3e';controlsMarkup+="\x3c/div\x3e";var tar=markupTemplate.querySelector("#pd_closebtn");tar.insertAdjacentHTML("afterend",controlsMarkup);var crtvMarkup="";crtvMarkup+='\x3ca id\x3d"pd_videoClick" target\x3d"_blank" href\x3d"'+
t.curl+'"\x3e';crtvMarkup+='\x3cvideo id\x3d"pd_video" class\x3d"video-js"'+t.enviros[t.pdEnv]["vparams"];crtvMarkup+=' poster\x3d"'+t.enviros[t.pdEnv]["iasset"]+'" data-setup\x3d"{}" width\x3d"100%" height\x3d"100%"\x3e';crtvMarkup+=' \x3csource src\x3d"'+t.enviros[t.pdEnv]["vasset"]+'" type\x3d"video/mp4"\x3e';crtvMarkup+="\x3c/video\x3e";crtvMarkup+="\x3c/a\x3e";tar=markupTemplate.querySelector("#pd_crtv");tar.insertAdjacentHTML("afterbegin",crtvMarkup);var output=markupTemplate.body.innerHTML;
t._generateFinalMarkup(output)};t.initVideoElements=function(){pd_video=videojs("pd_video");pd_rdy=false;pd_video_rdy=false;pd_hasplayed=false;pd_videoClick=document.getElementById("pd_videoClick");pd_volumebtn=document.getElementById("pd_volumebtn");pd_mutebtn=document.getElementById("pd_mutebtn");pd_unmutebtn=document.getElementById("pd_unmutebtn");pd_logo=document.getElementById("pd_logo");pd_overlay=document.getElementById("pd_overlay");pd_closeNavBtn=document.getElementById("nav-toggle")};t.videoClickThrough=
function(){pd_video.pause()};t.onVideoReady=function(){videojs("pd_video").ready(function(){var timeEvent=function(){var vctime=Math.round(pd_video.currentTime());var vdur=Math.round(pd_video.duration());var vprc=Math.round(vctime/vdur*100);if(!vtime25)if(vprc>=25){vtime25=true;t.pd_cont.insertAdjacentHTML("afterend",'\x3cimg style\x3d"display:none;" src\x3d"https://data.apn.co.nz/apnnz/count/actname\x3dAdFirstQuartile/fcid\x3d'+t.fcid+'"\x3e')}if(!vtime50)if(vprc>=50){vtime50=true;t.pd_cont.insertAdjacentHTML("afterend",
'\x3cimg style\x3d"display:none;" src\x3d"https://data.apn.co.nz/apnnz/count/actname\x3dAdMidPoint/fcid\x3d'+t.fcid+'"\x3e')}if(!vtime75)if(vprc>=75){vtime75=true;t.pd_cont.insertAdjacentHTML("afterend",'\x3cimg style\x3d"display:none;" src\x3d"https://data.apn.co.nz/apnnz/count/actname\x3dAdThirdQuartile/fcid\x3d'+t.fcid+'"\x3e')}if(!vtime100)if(vprc>=100){vtime100=true;t.pd_cont.insertAdjacentHTML("afterend",'\x3cimg style\x3d"display:none;" src\x3d"https://data.apn.co.nz/apnnz/count/actname\x3dAdComplete/fcid\x3d'+
t.fcid+'"\x3e')}};pd_video.on("timeupdate",timeEvent);pd_video.on("firstplay",function(){if(firstplay){t.pd_cont.insertAdjacentHTML("afterend",'\x3cimg style\x3d"display:none;" src\x3d"https://data.apn.co.nz/apnnz/count/actname\x3dAdStart/fcid\x3d'+t.fcid+'"\x3e');if(t.imptrk)t.pd_cont.insertAdjacentHTML("afterend",t.imptrk);firstplay=false}});t.addPushdownVideoEvents();pd_video_rdy=true})};t.videoSoundToggle=function(){if(pd_video.muted()==true){if(soundUnmuted==false){soundUnmuted=true;t.pd_cont.insertAdjacentHTML("afterend",
'\x3cimg style\x3d"display:none;" src\x3d"https://data.apn.co.nz/apnnz/count/actname\x3dPushdownSoundOn/fcid\x3d'+t.fcid+'"\x3e')}pd_video.muted(false);pd_unmutebtn.style.display="inline-block";pd_mutebtn.style.display="none"}else if(pd_video.muted()==false){pd_video.muted(true);pd_unmutebtn.style.display="none";pd_mutebtn.style.display="inline-block"}};t.videoPlay=function(){if(pd_video_rdy==true){pd_video.play();pd_hasplayed=true}};t.videoCheckScroll=function(){t._checkScroll();if(t.window_sY<t.main_h&&
pd_hasplayed==false&&pd_video_rdy==true){t._showPushdown();t.videoPlay();window.scrollTo(0,0)}if(pd_hasplayed==true&&t.pd_view<=.29&&pd_firstRun==false){pd_video.muted(true);pd_unmutebtn.style.display="none";pd_mutebtn.style.display="inline-block";pd_video.pause()}if(t.pd_view>=.3)t.videoPlay();pd_firstRun=false};t.handleNavOpenAndClose=function(){setTimeout(function(){t._adjustContainer()},350)};t.addPushdownVideoEvents=function(){window.addEventListener("scroll",t.videoCheckScroll);pd_volumebtn.addEventListener("click",
t.videoSoundToggle);t.pd_logo_link.addEventListener("click",t.videoClickThrough);t.pd_overlay_link.addEventListener("click",t.videoClickThrough);pd_videoClick.addEventListener("click",t.videoClickThrough);pd_videoClick.addEventListener("click",t._clickTrack);t.pd_closebtn.addEventListener("click",t.removePushdownVideo);t.pd_down.addEventListener("click",t.removePushdownVideo);pd_closeNavBtn.addEventListener("click",t.handleNavOpenAndClose)};t.removePushdownVideo=function(){pd_video.pause();window.removeEventListener("scroll",
t.videoCheckScroll);pd_volumebtn.removeEventListener("click",t.videoSoundToggle);t.pd_logo_link.removeEventListener("click",t.videoClickThrough);t.pd_overlay_link.removeEventListener("click",t.videoClickThrough);pd_videoClick.removeEventListener("click",t.videoClickThrough);pd_videoClick.removeEventListener("click",t._clickTrack);t.pd_closebtn.removeEventListener("click",t.removePushdownVideo);t.pd_down.removeEventListener("click",t.removePushdownVideo);pd_closeNavBtn.removeEventListener("click",
t.handleNavOpenAndClose)};t.initPushdownVideo=function(){t.generateVideoMarkup();t._addToDOM();t.initVideoElements();if(edata["pushdown"]["facebook"]){var fburl=decodeURIComponent(edata["pushdown"]["facebook"]);pd_overlay.innerHTML='\x3ciframe src\x3d"https://www.facebook.com/plugins/share_button.php?href\x3d'+fburl+'\x26layout\x3dbutton\x26size\x3dlarge\x26mobile_iframe\x3dtrue\x26appId\x3d1711736142399512\x26width\x3d73\x26height\x3d28" width\x3d"73" height\x3d"28" style\x3d"border:none;overflow:hidden" scrolling\x3d"no" frameborder\x3d"0" allowTransparency\x3d"true"\x3e\x3c/iframe\x3e';
...
'\x3cdiv id\x3d"sldr_zm'+unitId+'" class\x3d"sldr_zm" unitId\x3d"'+unitId+'"\x3e'+'\x3ca href\x3d"'+lcurl+'" target\x3d"_blank"\x3e'+'\x3cimg id\x3d"sldr_zm_img'+unitId+'" class\x3d"sldr_zm_img" src\x3d"'+lmedia+'"\x3e'+"\x3c/a\x3e"+"\x3c/div\x3e";var zoomIns=document.getElementsByTagName("body")[0];if(zoomIns)zoomIns.insertAdjacentHTML("afterbegin",zoom);var zoomState=false;function togZoom(e){var targetId=e.target.getAttribute("unitid");if(zoomState===false){document.getElementById("sldr_zm"+targetId).style.opacity=
1;document.getElementById("sldr_zm"+targetId).style.height="100vh";document.getElementById("sldr_zm"+targetId).style.display="inline-block";document.getElementById("sldr_zm_img"+targetId).style.height="auto";document.getElementById("sldr_close"+targetId).style.display="block";document.getElementById("sldr_img"+targetId).style.display="none";zoomState=true;if(zoomTracked===false){document.body.insertAdjacentHTML("afterbegin",zoomtrack);zoomTracked=true}}else if(zoomState===true){document.getElementById("sldr_zm"+
targetId).style.opacity=0;document.getElementById("sldr_zm"+targetId).style.height=0;document.getElementById("sldr_zm"+targetId).style.display="none";document.getElementById("sldr_zm_img"+targetId).style.height=0;document.getElementById("sldr_close"+targetId).style.display="none";document.getElementById("sldr_img"+targetId).style.display="block";zoomState=false}}document.getElementById("sldr_clip"+unitId).addEventListener("click",togZoom);document.getElementById("sldr_close"+unitId).addEventListener("click",
togZoom);document.getElementById("sldr_zm"+unitId).addEventListener("click",togZoom);var bg=document.getElementById("sldr_bg"+unitId);var img=document.getElementById("sldr_img"+unitId);var cont=document.getElementById("sldr_div"+unitId);var sldrzm=document.getElementById("sldr_zm"+unitId);var sldrzmimg=document.getElementById("sldr_zm_img"+unitId);$("img#sldr_bg"+unitId).on("load",function(){if(lsitever)$("#sldr_div"+unitId)[0].parentElement.style.maxWidth="970px";setCreative(img,cont,0);setBGWidth(bg,
cont);setTimeout(function(){$("#cubecont"+unitId).slideUp("slow",function(){document.getElementById("cubecont"+unitId).style.height=0;img.style.visibility="true"})},500)})}SliderLauncherD(edata["billboardSlider"])}}},false);
var rubicontag = rubicontag || {};
var ntag = ntag || {};

var nzmeads;

(function ($, ntag, rubicontag) {

	// Assign ntag to ntag if it exists, else declare it
	var ntag = ntag || {};
	var rubicontag = rubicontag || {};
	rubicontag.cmd = rubicontag.cmd || [];

	//var mobile = isMobile.any() && !isMobile.tablet(); // Returns true for phones, but not tablets.
	var mobile = isMobile.any();
	//var mobile = true;

	console.log('global ad script v13.32');
	...
	nzmeads = {
		...
		units: { lead: 0, rect: 0, drec: 0, bbrd: 0, mast: 0 },
		...
		setCats: function () {
			if (oParams["content_topics"] == undefined) {
				console.log('no oParams content_topics');
				return;
			} else {
				var cats = oParams["content_topics"];
				cats = cats.replace(/c-/g, "");
				cats = cats.replace(/\|/g, ",");
				console.log('found oParams content_topics: ', cats);
				nzmeads.cats = cats;
			}
		},
		...
		popSlot: function () {
			...
			if (width == 300 && height == 250) { //Rectangle 300x250
				...
				console.log('not mobile 970/760');
			...
			if (flsize && pos !== 'GAL') { // populate other FL params if flsize is set
				if (pos == 1) {
					flfold = 'atf';
				} else {
					flfold = 'btf';
			...
			console.log('');
			href = href + cats + 'BW=' + nzmeads.browserWidth + '/' + 'SYNC=' + nzmeads.syncId + '/' + 'RANDOM=' + nzmeads.getRandomNumber(10000000000) + '/' + 'VIEWID=' + nzmeads.viewId + '/';

			var o = {
				// E.g. http://www.nzherald.co.nz/ + 'RANDOM='...
				sasurl: href,
				divid: divId,
				sizes: [[width, height]],
				inventory: { domain: ktag.setSite(), section: ktag.setSection(), platform: ktag.setDeviceType() },
				visitor: {},
				position: flfold,
				keywords: flkw
			};

			if ((divId && pos != 0) || (href.indexOf('SPECIALOFFERCONTAINER') > -1)) { // The div must have an ID to render (set by an editor)
				console.log('pushing: ', width, 'x', height, ' href', href, ' pos: ', pos);
				nzmeads.slots.push(o); // Push the object to the to nzmeads.slots array.
			} else {
				console.log('not pushing: div: ', divId, ' ', width, 'x', height, ' href', href, ' pos: ', pos);
			}
		},

		showSlots: function () {

			for (var i = 0; i < nzmeads.slots.length; i++) {

				if (nzmeads.slots[i] && nzmeads.slots[i].divid) {

					if (nzmeads.slots[i].keywords) {

						ntag.displaySlot(nzmeads.slots[i].divid); // Iterate over every ad in the nzmeads.slots object and render the ad.

					} else if ($('#' + nzmeads.slots[i].divid).attr('data-ad-lazy-load')) {

						$('#' + nzmeads.slots[i].divid).attr('data-href', nzmeads.slots[i].sasurl);

					}else{

						var adFrame = ($('<iframe/>').attr({
							'height': nzmeads.slots[i].sizes[0][1],
							'width': nzmeads.slots[i].sizes[0][0],
							'scrolling': 'no',
							...
							'src': nzmeads.slots[i].sasurl
						}));

						$('#' + nzmeads.slots[i].divid).append(adFrame);
						//console.log('frame added',adFrame);
					}
		...
		//refresh slot - pass in node, tweak params, remove children and create new iframe
		...
		getPrerollURL: function () {
			...
			console.log('preroll adURL: ', href);
			return href;
		},
		...
		runEvents: function () {
			...
			$('.pb-ad-container').each(nzmeads.popSlot); //Build the nzmeads.slots array by looping through every ad on the page

			//console.log(nzmeads.slots);
			ntag.loadFastLane();

			if (!mobile) {

				ntag.addContext('desktop');

			} else if (mobile) {

				ntag.addContext('mobile');

				nzmeads.runShowcase();
			}

			ntag.loadSlots(nzmeads.slots);
			setTimeout(function () { ntag.sasrun; console.log('ntag.sasrun'); }, 5000);
			nzmeads.showSlots();
		}
	};
